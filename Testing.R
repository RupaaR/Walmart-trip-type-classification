...
#Creating a function to calculate number of missing values, proportion of missing values and number of unique values across each column
...
write.csv(a_test_predictions,"rf.csv")